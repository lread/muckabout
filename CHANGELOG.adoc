...
== v1.3.1 - 2022-09-26 [[v1.3.1]]

* rename pubchecks task to pubcheck
* turn on javac linting

https://github.com/lread/muckabout/compare/Release-1.2.0\...v1.3.1[commit log]
